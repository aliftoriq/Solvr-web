...
import { ReviewNotesComponent } from "../review-marketing-page/review-notes/review-notes.component";
...
export class ApprovalBmPageComponent {
  ...
  submitReview(reviewData: { loanId: string, notes: string }): void {
    this.approvalBmService.reviewLoanApplication(reviewData.loanId, reviewData.notes).subscribe({
      next: () => {
